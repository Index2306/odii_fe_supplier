  ...
  const columns = useMemo(
    () => [
        ...
        render: (text, record, index) => {
          return (
            <div className="product-name-wrapper">
              <Image src={text?.thumb?.location || text?.thumb} />
      ...
      },
      {
        ...
        render: (text, record, index) => (
          <InputNumber
            ...
            max={record.total_import_quantity - record.remaining_quantity}
          />
        ),
      },
      {
      ...
      },
      {
        ...
        render: (text, record) => (
          <InputNumber
            value={record.total_import_quantity - text}
            disabled={true}
          />
        ),
      },
      ...
      <CustomSectionWrapper mt={{ xs: 's4' }}>
        ...
        <>
          <div className="total_quantity_info">
            Số lượng: {sum(products?.map(item => item.total_quantity))} sản phẩm
          </div>
          <div className="total_quantity_info">
            Giá trị lô xuất:{' '}
            {formatMoney(
