...
function Info({ layout, has_variation, isProductSource, is_stock }) {
  const normFile = e => {
    if (Array.isArray(e)) {
      return e;
    }
        ...
        <CustomSectionWrapper mt={{ xs: 's4' }}>
          <Row gutter={24}>
            <Col span={12}>
              ...
              >
                <CustomWarehousing type={WAREHOUSE_TYPE.PICKUP} />
              </Item>
            </Col>
            <Col span={12}>
              <Item
                name="supplier_warehouse_return"
                label="Kho trả hàng"
                valuePropName="value"
                getValueFromEvent={normFile}
                {...layout}
              >
                <CustomWarehousing type={WAREHOUSE_TYPE.RETURN} />
              </Item>
            </Col>
          </Row>
            ...
            {!has_variation && (
              <Col span={12}>
                <Item
                  ...
                  {...layout}
                >
                  <InputNumber min={1} size="large" placeholder="Số lượng" />
                </Item>
              </Col>
            )}
          </Row>
